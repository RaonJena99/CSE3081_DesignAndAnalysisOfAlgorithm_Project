...
int main(){
    ...
    file.open("./LPS_command.txt"); // command.txt 열기
    ...
    while(command_cnt--){
        ...
        in.open("./" + input); // input.txt 열기
        result.open("./" + output); // output.txt 열기
